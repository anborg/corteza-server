...
func (n *messagingChannel) Prepare(ctx context.Context, s store.Storer, rs *envoy.ResourceState) (err error) {
	// Sys users
...
// should be changed.
func (n *messagingChannel) Encode(ctx context.Context, s store.Storer, state *envoy.ResourceState) (err error) {
	res := n.res.Res
