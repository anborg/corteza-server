...
func (n *composeNamespace) Prepare(ctx context.Context, s store.Storer, state *envoy.ResourceState) (err error) {
...
// should be changed.
func (n *composeNamespace) Encode(ctx context.Context, s store.Storer, state *envoy.ResourceState) (err error) {
	res := n.res.Res
