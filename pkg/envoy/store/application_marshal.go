...
func (n *application) Prepare(ctx context.Context, s store.Storer, rs *envoy.ResourceState) (err error) {
...
// should be changed.
func (n *application) Encode(ctx context.Context, s store.Storer, state *envoy.ResourceState) (err error) {
	res := n.res.Res
